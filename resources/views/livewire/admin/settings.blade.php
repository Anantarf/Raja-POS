<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-[#3F7A5D]/10 via-[#3F7A5D]/5 to-white border border-slate-200/80 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="space-y-1">
            <h1 class="text-2xl sm:text-3xl font-extrabold text-[#232E28] tracking-tight">Pengaturan Toko &amp; Sistem</h1>
    ...
    <div class="flex flex-wrap gap-2 border-b border-slate-200/80 pb-3 text-base font-extrabold">
        @foreach([
            ...
            <a href="{{ $href }}" class="px-4 py-2.5 rounded-xl transition-all duration-200 {{ $activeTab === $tab ? 'bg-[#3F7A5D] text-white shadow-xs' : 'text-[#52645B] hover:bg-[#F3F6F4] hover:text-[#232E28]' }}">{{ $label }}</a>
        @endforeach
    </div>
