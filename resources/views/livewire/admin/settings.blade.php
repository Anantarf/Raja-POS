<div class="space-y-6">
    ...
    <div class="bg-white p-5 rounded-2xl border border-slate-200/80 border-l-4 border-l-[#3F7A5D] shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="space-y-0.5">
            ...
            <p class="text-sm text-[#718379] font-medium leading-relaxed">Kelola profil toko, pengguna sistem, role &amp; hak akses, metode pembayaran, dan lokasi cabang.</p>
        </div>
    ...
    <!-- Navigation Sub-Tabs -->
    <div class="flex flex-wrap gap-2 border-b border-slate-200/80 pb-3 text-sm font-extrabold">
        @foreach([
            ...
            <a href="{{ $href }}" class="px-4 py-2.5 rounded-xl transition-all duration-200 {{ $activeTab === $tab ? 'bg-[#3F7A5D] text-white shadow-sm' : 'text-[#52645B] hover:bg-[#F3F6F4] hover:text-[#232E28]' }}">{{ $label }}</a>
        @endforeach
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-5">
            ...
            <div class="lg:col-span-3 bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm space-y-5">
                <div class="flex items-start justify-between gap-4 border-b border-slate-100 pb-3.5">
                    <div>
                        <h3 class="text-base font-extrabold text-[#232E28] uppercase tracking-wider">Profil &amp; Preferensi Toko</h3>
                        <p class="text-sm text-[#718379] font-medium mt-0.5">Konfigurasi dasar operasional kasir, cetak struk, dan pencatatan laporan.</p>
                    </div>
                    <span class="px-3 py-1 rounded-lg bg-[#E3EEE8] text-[#3F7A5D] text-xs font-black uppercase tracking-wider border border-[#3F7A5D]/20">Aktif &amp; Berjalan</span>
                </div>
            ...
            <div class="lg:col-span-2 bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm space-y-4">
                <div class="border-b border-slate-100 pb-3.5">
                    <h3 class="text-base font-extrabold text-[#232E28] uppercase tracking-wider">Panduan &amp; Spesifikasi Sistem</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-5">
            ...
            <div class="lg:col-span-3 bg-white border border-slate-200/80 rounded-2xl shadow-sm overflow-hidden">
                <div class="p-5 border-b border-slate-100">
                    <h3 class="text-base font-extrabold text-[#232E28] uppercase tracking-wider">Daftar Pengguna Sistem</h3>
            ...
            <div class="lg:col-span-2 bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm space-y-4">
                <div class="border-b border-slate-100 pb-3">
                    <h3 class="text-base font-extrabold text-[#232E28] uppercase tracking-wider">Tambah Pengguna Baru</h3>
                ...
                <form wire:submit.prevent="addUser" class="space-y-3.5 text-sm">
                    <div>
                        ...
                        <input type="text" wire:model="userName" placeholder="Budi Santoso" class="w-full h-11 px-3.5 border border-slate-200 rounded-xl bg-[#F3F6F4] text-[#232E28] font-semibold text-sm focus:bg-white focus:ring-2 focus:ring-[#3F7A5D]/20 focus:border-[#3F7A5D]" required />
                    </div>
                    <div>
                        <label class="block text-[#718379] font-extrabold uppercase tracking-wider text-xs mb-1">Username Login *</label>
                        <input type="text" wire:model="userUsername" placeholder="kasir_budi" class="w-full h-11 px-3.5 border border-slate-200 rounded-xl bg-[#F3F6F4] text-[#232E28] font-mono font-bold text-sm focus:bg-white focus:ring-2 focus:ring-[#3F7A5D]/20 focus:border-[#3F7A5D]" required />
                    </div>
                    <div>
                        <label class="block text-[#718379] font-extrabold uppercase tracking-wider text-xs mb-1">Password *</label>
                        <input type="password" wire:model="userPassword" placeholder="••••••••" class="w-full h-11 px-3.5 border border-slate-200 rounded-xl bg-[#F3F6F4] text-[#232E28] font-semibold text-sm focus:bg-white focus:ring-2 focus:ring-[#3F7A5D]/20 focus:border-[#3F7A5D]" required />
                    </div>
                    <div>
    ...
    @elseif($activeTab === 'ROLES')
        <div class="bg-white border border-slate-200/80 rounded-2xl shadow-sm overflow-hidden">
            <div class="p-5 border-b border-slate-100">
                <h3 class="text-base font-extrabold text-[#232E28] uppercase tracking-wider">Role &amp; Wewenang Akses</h3>
    ...
    @elseif($activeTab === 'LOCATIONS')
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-5">
            <div class="lg:col-span-3 bg-white border border-slate-200/80 rounded-2xl shadow-sm overflow-hidden">
                <div class="p-5 border-b border-slate-100">
                    <h3 class="text-base font-extrabold text-[#232E28] uppercase tracking-wider">Daftar Lokasi Cabang Toko</h3>
            ...
            <div class="lg:col-span-2 bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm space-y-4">
                <div class="border-b border-slate-100 pb-3">
                    <h3 class="text-base font-extrabold text-[#232E28] uppercase tracking-wider">Tambah Cabang Toko</h3>
                ...
                <form wire:submit.prevent="addLocation" class="space-y-3.5 text-sm">
                    <div>
                        ...
                        <input type="text" wire:model="locationCode" placeholder="RAJA-BANGO" class="w-full h-11 px-3.5 border border-slate-200 rounded-xl font-mono uppercase bg-[#F3F6F4] text-[#232E28] font-bold text-sm focus:bg-white focus:ring-2 focus:ring-[#3F7A5D]/20 focus:border-[#3F7A5D]" required />
                    </div>
                    <div>
                        <label class="block text-[#718379] font-extrabold uppercase tracking-wider text-xs mb-1">Nama Cabang Toko *</label>
                        <input type="text" wire:model="locationName" placeholder="Raja Aksesoris Bango" class="w-full h-11 px-3.5 border border-slate-200 rounded-xl bg-[#F3F6F4] text-[#232E28] font-semibold text-sm focus:bg-white focus:ring-2 focus:ring-[#3F7A5D]/20 focus:border-[#3F7A5D]" required />
                    </div>
                    <button type="submit" class="w-full h-10 bg-[#3F7A5D] hover:bg-[#32634B] text-white font-extrabold rounded-xl transition text-sm uppercase tracking-wider cursor-pointer shadow-sm active:scale-95 flex items-center justify-center">
                        + Tambah Cabang Toko
                    </button>
    ...
    @else
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-5">
            <div class="lg:col-span-3 bg-white border border-slate-200/80 rounded-2xl shadow-sm overflow-hidden">
                <div class="p-5 border-b border-slate-100">
                    <h3 class="text-base font-extrabold text-[#232E28] uppercase tracking-wider">Metode Pembayaran Toko</h3>
            ...
            <div class="lg:col-span-2 bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm space-y-4">
                <div class="border-b border-slate-100 pb-3">
                    <h3 class="text-base font-extrabold text-[#232E28] uppercase tracking-wider">Tambah Metode Pembayaran</h3>
                ...
                <form wire:submit.prevent="addPaymentMethod" class="space-y-3.5 text-sm">
                    <div>
                        ...
                        <input type="text" wire:model="pmName" placeholder="Transfer Bank BCA / QRIS" class="w-full h-11 px-3.5 border border-slate-200 rounded-xl bg-[#F3F6F4] text-[#232E28] font-semibold text-sm focus:bg-white focus:ring-2 focus:ring-[#3F7A5D]/20 focus:border-[#3F7A5D]" required />
                    </div>
                    <div>
