            ...
            <table class="w-full text-xs text-left">
                <thead class="bg-[#F3F6F4] border-b border-[#E3EEE8] text-[#718379] uppercase text-[10px] font-extrabold tracking-wider">
                    <tr>
                        ...
                        <th class="py-4 px-5 text-center">Aksi Pemulihan</th>
                    </tr>
                </thead>
                    ...
                    @forelse($trashedSales as $sale)
                        <tr class="hover:bg-[#F3F6F4]/60 transition">
                            <td class="py-4 px-5">
                                ...
                                <div class="text-[10px] text-[#718379] mt-1 font-semibold">Dibatalkan: {{ $sale->updated_at->format('d M Y, H:i') }}</div>
                            </td>
                            <td class="py-4 px-5 text-[#232E28]">
                                <div class="font-bold text-[#232E28]">{{ $sale->user?->name }}</div>
                                <div class="text-[10px] text-[#718379] font-semibold">{{ $sale->location?->name }}</div>
                            </td>
                            <td class="py-4 px-5 text-right font-mono font-extrabold text-rose-600 text-sm">
