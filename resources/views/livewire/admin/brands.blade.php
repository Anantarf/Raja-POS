<div class="space-y-5">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-extrabold text-[#232E28] tracking-tight">Merk / Brand Produk</h1>
    ...
    <div class="bg-white p-3.5 sm:p-4 rounded-2xl border border-slate-200/80 shadow-sm flex items-center justify-between text-xs">
        <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari nama brand..." class="w-full sm:w-1/3 px-3.5 py-2 border border-slate-200 rounded-xl text-xs focus:ring-2 focus:ring-[#3F7A5D]/20 focus:border-[#3F7A5D] bg-[#F3F6F4]" />
    </div>
