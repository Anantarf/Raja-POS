<div class="space-y-5">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-3.5">
        <!-- 1. Total Omzet -->
        <div class="bg-white rounded-2xl p-3.5 sm:p-4 border border-slate-200/80 hover:border-[#047857]/50 shadow-xs transition cursor-default">
            <div class="flex items-center justify-between mb-1.5">
                ...
                @if(($metrics['omzet_growth'] ?? 0) > 0)
                    <span class="px-2 py-0.5 rounded-md text-[10px] font-bold text-[#047857] bg-[#E3EEE8] border border-[#047857]/20 shrink-0">
        ...
        <div class="bg-white rounded-2xl p-3.5 sm:p-4 border border-slate-200/80 hover:border-[#047857]/50 shadow-xs transition cursor-default">
            <div class="flex items-center justify-between mb-1.5">
                ...
                <span class="px-2 py-0.5 rounded-md text-[10px] font-bold text-[#047857] bg-[#E3EEE8] shrink-0">
                    Aktif
                </span>
            </div>
            <div class="text-lg sm:text-xl lg:text-2xl font-extrabold text-[#2C3E35] font-mono tracking-tight truncate">
            ...
            <a href="/admin/balances" class="inline-flex mt-1 text-[11px] sm:text-xs text-[#047857] font-bold hover:text-[#065F46] hover:underline">Lihat rincian saldo</a>
        </div>
