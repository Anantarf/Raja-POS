        ...
        <div class="flex-1 overflow-y-auto px-4 py-6 space-y-7">
            ...
            <div>
                ...
                <nav class="space-y-1.5">
                    <a href="/admin/dashboard" class="flex items-center gap-3.5 px-4 py-3 rounded-xl text-[1rem] font-bold transition-all duration-200 hover:translate-x-1.5 {{ request()->is('admin', 'admin/dashboard') ? 'bg-[#3F7A5D] text-white shadow-emco-primary hover-lift' : 'text-[#52645B] hover:bg-[#F3F6F4] hover:text-[#232E28]' }}">
            ...
            <div>
                ...
                <nav class="space-y-1.5">
                    <a href="/admin/products" class="flex items-center gap-3.5 px-4 py-3 rounded-xl text-[1rem] font-bold transition-all duration-200 hover:translate-x-1.5 {{ request()->is('admin/products*') ? 'bg-[#3F7A5D] text-white shadow-emco-primary hover-lift' : 'text-[#52645B] hover:bg-[#F3F6F4] hover:text-[#232E28]' }}">
                        <svg class="w-5.5 h-5.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/admin/inventory-movements" class="flex items-center gap-3.5 px-4 py-3 rounded-xl text-[1rem] font-bold transition-all duration-200 hover:translate-x-1.5 {{ request()->is('admin/inventory-movements*') ? 'bg-[#3F7A5D] text-white shadow-emco-primary hover-lift' : 'text-[#52645B] hover:bg-[#F3F6F4] hover:text-[#232E28]' }}">
                        <svg class="w-5.5 h-5.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <nav class="space-y-1.5">
                    <a href="/admin/sales" class="flex items-center gap-3.5 px-4 py-3 rounded-xl text-[1rem] font-bold transition-all duration-200 hover:translate-x-1.5 {{ request()->is('admin/sales*') ? 'bg-[#3F7A5D] text-white shadow-emco-primary hover-lift' : 'text-[#52645B] hover:bg-[#F3F6F4] hover:text-[#232E28]' }}">
                        <svg class="w-5.5 h-5.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        <span>Riwayat Transaksi</span>
                    </a>
                    <a href="/admin/balances" class="flex items-center gap-3.5 px-4 py-3 rounded-xl text-[1rem] font-bold transition-all duration-200 hover:translate-x-1.5 {{ request()->is('admin/balances*') ? 'bg-[#3F7A5D] text-white shadow-emco-primary hover-lift' : 'text-[#52645B] hover:bg-[#F3F6F4] hover:text-[#232E28]' }}">
                        <svg class="w-5.5 h-5.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <nav class="space-y-1.5">
                    <a href="/admin/reports" class="flex items-center gap-3.5 px-4 py-3 rounded-xl text-[1rem] font-bold transition-all duration-200 hover:translate-x-1.5 {{ request()->is('admin/reports*') ? 'bg-[#3F7A5D] text-white shadow-emco-primary hover-lift' : 'text-[#52645B] hover:bg-[#F3F6F4] hover:text-[#232E28]' }}">
                        <svg class="w-5.5 h-5.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <nav class="space-y-1.5">
                    <a href="/admin/settings" class="flex items-center gap-3.5 px-4 py-3 rounded-xl text-[1rem] font-bold transition-all duration-200 hover:translate-x-1.5 {{ request()->is('admin/settings*') ? 'bg-[#3F7A5D] text-white shadow-emco-primary hover-lift' : 'text-[#52645B] hover:bg-[#F3F6F4] hover:text-[#232E28]' }}">
                        <svg class="w-5.5 h-5.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
