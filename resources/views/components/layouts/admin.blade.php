        ...
        <div class="flex-1 overflow-y-auto px-3 py-4 space-y-5">
            ...
            <div>
                ...
                <nav class="space-y-0.5">
                    ...
                    <a href="/admin/trash" @click="mobileMenuOpen = false" class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm font-bold text-rose-700 bg-rose-50/70 hover:bg-rose-100/80 transition-all duration-200 hover:translate-x-1 border border-rose-200/60 active-press">
