        ...
        <div class="p-5 flex-1 overflow-y-auto space-y-5 text-sm font-semibold">
            @php
                $groups = [
                    ...
                    'Operasional' => [
                        ['label' => 'Sales', 'href' => '/admin/sales', 'active' => request()->is('admin/sales'), 'icon' => 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z'],
                    ...
                    'Katalog' => [
                        ['label' => 'Produk', 'href' => '/admin/products', 'active' => request()->is('admin/products'), 'icon' => 'M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5'],
                        ['label' => 'Kategori', 'href' => '/admin/categories', 'active' => request()->is('admin/categories'), 'icon' => 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z'],
                        ['label' => 'Brand', 'href' => '/admin/brands', 'active' => request()->is('admin/brands'), 'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5'],
                    ],
                    'Keuangan' => [
                    ...
                    'Laporan' => [
                        ['label' => 'Sales', 'href' => '/admin/reports/sales', 'active' => request()->is('admin/reports/sales'), 'icon' => 'M3 3v18h18M7 16l3-3 3 2 4-6'],
                        ['label' => 'Inventory', 'href' => '/admin/reports/inventory', 'active' => request()->is('admin/reports/inventory'), 'icon' => 'M20 7l-8-4-8 4m16 0v10l-8 4-8-4V7'],
                        ['label' => 'Payment', 'href' => '/admin/reports/payment', 'active' => request()->is('admin/reports/payment'), 'icon' => 'M3 10h18M7 15h.01M11 15h2M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
                        ['label' => 'Balance', 'href' => '/admin/reports/balance', 'active' => request()->is('admin/reports/balance'), 'icon' => 'M3 6h18M3 10h18M5 6v14h14V6'],
                        ['label' => 'Product', 'href' => '/admin/reports/product', 'active' => request()->is('admin/reports/product'), 'icon' => 'M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5'],
                    ],
                    'Owner Settings' => [
                        ['label' => 'Users', 'href' => '/admin/settings/users', 'active' => request()->is('admin/settings/users'), 'icon' => 'M17 20h5v-2a4 4 0 00-4-4h-1M9 20H4v-2a4 4 0 014-4h1m4-4a4 4 0 100-8 4 4 0 000 8z'],
                        ['label' => 'Roles', 'href' => '/admin/settings/roles', 'active' => request()->is('admin/settings/roles'), 'icon' => 'M9 12l2 2 4-4m5-4v6c0 5-3.5 9-8 10-4.5-1-8-5-8-10V6l8-3 8 3z'],
                        ['label' => 'Payment Methods', 'href' => '/admin/settings/payment-methods', 'active' => request()->is('admin/settings/payment-methods'), 'icon' => 'M3 10h18M7 15h.01M11 15h2M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
                        ['label' => 'Locations', 'href' => '/admin/settings/locations', 'active' => request()->is('admin/settings/locations'), 'icon' => 'M17.657 16.657L13.414 20.9a2 2 0 01-2.828 0l-4.243-4.243a8 8 0 1111.314 0z'],
                        ['label' => 'Store Settings', 'href' => '/admin/settings/store-settings', 'active' => request()->is('admin/settings') || request()->is('admin/settings/store-settings'), 'icon' => 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066 1.724 1.724 0 012.37 2.37 1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573 1.724 1.724 0 01-2.37 2.37 1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066 1.724 1.724 0 01-2.37-2.37 1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573 1.724 1.724 0 012.37-2.37 1.724 1.724 0 002.572-1.065z'],
                    ],
                ];
            @endphp
