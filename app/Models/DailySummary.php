...
class DailySummary extends Model
{
    ...
    protected $casts = [
        ...
        'bca_saldo_awal' => 'decimal:2',
        'bca_topup' => 'decimal:2',
        'bca_trx' => 'decimal:2',
        'bca_saldo_android' => 'decimal:2',
        'multi_saldo_awal' => 'decimal:2',
        'multi_topup' => 'decimal:2',
        'multi_trx' => 'decimal:2',
        'multi_saldo_android' => 'decimal:2',
        'wahana_saldo_awal' => 'decimal:2',
        'wahana_topup' => 'decimal:2',
        'wahana_trx' => 'decimal:2',
        'wahana_saldo_android' => 'decimal:2',
